...
export default function Login({setUser}) {
    ...
    const makeAccount = () => {
        console.log("this should make an account and log in with it")
    }
    ...
    useEffect(() => {
        ...
        if( ! verifyUser || passwordInput.length === 0) {
        ...
        async function getUserInfo() {
            api.getUserInfo(userInput, passwordInput)
                .then( userInfo => {
                    console.log(userInput, passwordInput, userInfo)
        ...
        getUserInfo();
    }, [verifyUser, setUser, passwordInput]);
